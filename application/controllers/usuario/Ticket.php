...
class Ticket extends CI_Controller{
    ...
    function asignado(){
        ...
        $data['listado'] = $this->ticket_ml->listadoTicketsByUser('Asignado');

        $this->load->view('usuario/template/header_view');
        $this->load->view('usuario/tickets/asignado_view',$data);
    ...
    function rechazado(){
        ...
        $data['listado'] = $this->ticket_ml->listadoTicketsByUser('Rechazado');

        $this->load->view('usuario/template/header_view');
        $this->load->view('usuario/tickets/rechazado_view',$data);
        $this->load->view('usuario/template/footer_view');
        $this->load->view('lib/js_dashboard_template');
        $this->load->view('lib/js_ticket');
    }
    ...
    function cerrado(){
        ...
        $data['listado'] = $this->ticket_ml->listadoTicketsByUser('Cerrado');

        $this->load->view('usuario/template/header_view');
        $this->load->view('usuario/tickets/cerrado_view',$data);
        $this->load->view('usuario/template/footer_view');
        $this->load->view('lib/js_dashboard_template');
        $this->load->view('lib/js_ticket');
    }
    ...
    function create(){
		...
		$this->load->view('usuario/template/header_view');
        $this->load->view('usuario/tickets/create_view',$data);
        $this->load->view('usuario/template/footer_view');
        $this->load->view('lib/js_dashboard_template');
	}
	...
	function store(){
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($add == TRUE){
                ...
                redirect('usuario/ticket/asignado', 'refresh');
            }else{
                $this->session->set_flashdata('info','¡INFO! Los datos no se han podido guardar');
                redirect('usuario/ticket/create', 'refresh');
            }
        }
	}
    ...
    function show($id){
		...
		$this->load->view('usuario/template/header_view');
        $this->load->view('usuario/tickets/show_view',$data);
        $this->load->view('usuario/template/footer_view');
        $this->load->view('lib/js_dashboard_template');
    }
	...
	function edit($id){
		...
		$this->load->view('usuario/template/header_view');
        $this->load->view('usuario/tickets/edit_view',$data);
        $this->load->view('usuario/template/footer_view');
        $this->load->view('lib/js_dashboard_template');
    }
    ...
    function closet($id){
		...
		$this->load->view('usuario/template/header_view');
        $this->load->view('usuario/tickets/closet_view',$data);
        $this->load->view('usuario/template/footer_view');
        $this->load->view('lib/js_dashboard_template');
    }
